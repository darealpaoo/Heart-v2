export default class DebugDrawer {
  ...
  constructor({ THREE, count = 100000 }) {
    ...
    let points = new THREE.BufferAttribute(
    ...
    let moveto = (this.moveto = (p, d, q) =>
      (d !== undefined && cursor.set(p, d, q)) || cursor.copy(p));
    ...
    this.circle = (radius = 0.1, sides = 16) => {
      v2.copy(cursor);
    ...
    };
    {
      let n = vec3();
      let p = vec3();
      this.aabox = (x = 0, y = 0, z = 0, sx = 0.5, sy = sx, sz = sx) => {
